...
import { 
  FaHome, FaInfo, FaCube, FaEnvelope,
  ...
  const ThemeToggle = () => (
    <motion.button
      ...
      className={`
        ...
        ${isDarkMode 
          ? 'focus:ring-[#486d37]/50' 
          : 'focus:ring-[#486d37]/30'
        }
      `}
          ...
          >
            ...
            <div 
              className={`
                ...
                ${isDarkMode 
                  ? 'bg-gradient-to-br from-gray-800 via-dgreen-900 to-indigo-900' 
                  : 'bg-gradient-to-br from-dgreen-200 via-purple-200 to-indigo-200'
                }
              `}
            >
              {navItems.map((item, index) => (
